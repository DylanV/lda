...
private:
    ...
    // Model parameters
    // ================
    double alpha = 1.0;                       /*!< Symmetrc dirichlet alpha parameter. Topic distribution prior. */
    double beta = 0.1;                      /*!< Symmetric dirichlet beta parameter. Topic word distribution prior. */
