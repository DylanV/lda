...
/*!
    Initiliases the inference variables.
 */
...
/*!
    Randomly assign a topic to each word in the corpus. Note that words can be repeated in a document;
    hence the need to repeatably sample when neccessary. You do not want all instances of a repeated
    word to have the same assigned topic.
 */
...
/*!
    ...
    \param d The given document id
    \param w The given word in the document
 */
...
/*!
    Sample from a multinomial distribution with the given mass.
    \param probabilies The mass function for the multinomial
 */
